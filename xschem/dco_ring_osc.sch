...
C {dco_cc_inv.sym} 150 -90 0 0 {name=x1}
C {dco_cc_inv.sym} 330 -90 0 0 {name=x2}
C {dco_cc_inv.sym} 510 -90 0 0 {name=x3}
C {dco_cc_inv.sym} 690 -90 0 0 {name=x4}
C {dco_cc_inv.sym} 870 -90 0 0 {name=x5}
